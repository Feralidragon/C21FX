...
defaultproperties
{
	...
	LensflarePresetSun(7)=(Position=(Mode=LPM_Distributed,Distribution=(Seed=87,Count=15,Mode=LPDM_Both)))
	...
	LensflarePresetSun(8)=(Position=(Mode=LPM_Distributed,Distribution=(Seed=87,Count=15,Mode=LPDM_Both)))
